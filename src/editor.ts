...
export default class Editor {
  ...
  fit() {
    this.#canvasEl.width = (this.#canvasEl.parentElement as HTMLElement).clientWidth;
    this.#canvasEl.height = (this.#canvasEl.parentElement as HTMLElement).clientHeight;
